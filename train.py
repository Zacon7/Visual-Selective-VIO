...
parser.add_argument('--beta_warmup', type=float, default=0.25, help='weight to balance relative & absolute pose loss.')
parser.add_argument('--beta_joint', type=float, default=0.25, help='weight to balance relative & absolute pose loss.')
parser.add_argument('--beta_fine1', type=float, default=0.25, help='weight to balance relative & absolute pose loss.')
parser.add_argument('--beta_fine2', type=float, default=0.25, help='weight to balance relative & absolute pose loss.')
...
parser.add_argument('--experiment_name', type=str, default='AdaVIO_1', help='experiment name')
