...
parser.add_argument('--experiment_name', type=str, default='fastflow_new3', help='experiment name')
parser.add_argument('--ckpt_model', type=str, default='results/train/fastflow_hard_3e-5/checkpoints/best_10.92.pth', help='path to the checkpoint model')
