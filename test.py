...
parser.add_argument('--experiment_name', type=str, default='AdaVIO', help='experiment name')
parser.add_argument('--ckpt_model', type=str, default='results/train/AdaVIO/checkpoints/best_15.78.pth', help='path to the checkpoint model')
