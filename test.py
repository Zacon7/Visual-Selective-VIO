...
parser.add_argument('--fuse_method', type=str, default='soft', help='fusion method [cat, soft, hard, EFA]')
...
parser.add_argument('--ckpt_model', type=str, default='results/train/flownet/flownet_soft/checkpoints/best_6.89.pth', help='path to the checkpoint model')
